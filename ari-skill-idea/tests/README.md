...
- `README.md` — this file.
- `test_contracts.py` — candidate admission, explicit rejection, generation locks, and research-contract minting.
- `test_server.py` — exercises `survey`, `generate_ideas`, the config/LLM helpers, the discussion loop, and pinned-idea append/dedup.
