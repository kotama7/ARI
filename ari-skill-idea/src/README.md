...
Semantic Scholar) and LLM-based research-idea generation, the latter
...
- `contracts.py` — idea-candidate, rejection, generation-lock, and immutable research-contract admission helpers.
