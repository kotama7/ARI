...
ARI autonomously designed, implemented, ran, and wrote up an end-to-end study of **CSR-SpMM** (sparse matrix–dense matrix multiplication) on the Fujitsu A64FX/SVE-512 CPU. The full paper — including methodology, algorithms, figures, and references — is available in [`docs/assets/sample_paper.pdf`](docs/assets/sample_paper.pdf).
