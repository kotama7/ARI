...
def _api_models() -> dict:
    ...
    return {
        "providers": [
            ...
            # the catalog would have deleted it from the UI.
            {"id": "claude_code", "name": "Claude Code (local)", "models": ["claude-opus-5", "claude-sonnet-5", "claude-opus-4-8", "claude-haiku-4-5"]},
