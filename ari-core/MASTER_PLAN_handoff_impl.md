...
| root 横断: core.py dispatch / cost_tracker provenance | [`ari/Plan.md`](ari/Plan.md) | ari(root) | evaluator, agent, llm |
| memory backend: RQ-C surface/topology / retrieved-text log | [`../ari-skill-memory/Plan.md`](../ari-skill-memory/Plan.md) | ari-skill-memory | agent, orchestrator（Phase C 主体） |
...
- [ ] root 横断 (core.py dispatch / cost_tracker provenance) — land __ / 実機 gate __
- [ ] memory backend (RQ-C surface/topology・Phase C) — land __ / 実機 gate __
