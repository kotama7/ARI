...
% ============================== evidence assembly (paper-input synthesis)
% Best node of a run (argmax scientific reward over non-erased nodes,
% validated/deeper tie-break),
% the assembled evidence record handed to the writer, and the set of declared
% input-parameter keys held out of every per-key reduction.
\newcommand{\bestnode}{n^{\star}}
