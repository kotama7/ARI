...
\begin{tikzpicture}[node distance=0.5cm and 1.6cm]
  ...
  \node[station, below=of depth]                       (retry)  {\figlabel{F3.retry}};
  \node[station, below=of retry]                       (summ)   {\figlabel{F3.summary}};
  ...
  % --- edges -----------------------------------------------------
  \foreach \n in {real,metrics,depth,retry,summ}
    \draw[arrow] (\n.east) -- (sel.west);
  ...
  \begin{scope}[on background layer]
    \node[stage container, fit=(real)(metrics)(depth)(retry)(summ)(div)] (col) {};
