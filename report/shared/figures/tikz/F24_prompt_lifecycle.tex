...
% the T16 emergency quarantine — the only transition that may commit
% mid-epoch. Dotted margin paths: exoneration re-entry (T18) and the
...
\begin{tikzpicture}[aricanvas]
  ...
  % the one accent role: the mid-epoch emergency edge (T16)
