...
Snapshot copies of the runtime LLM prompts (`ari-core/ari/prompts/**`), regenerated via `make snapshot-prompts`. Each file carries a header with its source path, SHA-256, and git commit. Do not edit by hand.
