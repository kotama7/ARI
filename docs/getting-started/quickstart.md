...
> - 📄 **Sample output paper** — [`sample_paper.pdf`](../assets/sample_paper.pdf) is a real paper generated by ARI, including figures, citations, and the reproducibility verification report.
