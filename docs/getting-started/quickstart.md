...
> - 📄 **Sample output paper** — [`sample_paper.pdf`](../assets/sample_paper.pdf) is a real 10-page paper generated by ARI on the Fujitsu A64FX/SVE-512 platform: a Stratum-Roofline CSR-SpMM study with figures, citations, and the reproducibility verification report.
