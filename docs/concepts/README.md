...
- `harness-pool.md` — Harness Pool: why a task should have several harnesses to choose between, what a harness must declare about itself (including what it is blind to), and why selection must never rank on results.
