...
- `docs/architecture.md#plan--venue-contract-v070` — 完全な 2 ファイル契約
- `docs/architecture.md#publication-lifecycle-v070` — `experiment.md` 周辺の出力
- `docs/skills.md` — どのスキルが `experiment.md` のどのセクションを消費するか
