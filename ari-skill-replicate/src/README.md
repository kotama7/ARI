...
- `migration.py` — explicit legacy replication-rubric conversion with audit and loss records.
- `provenance.py` — immutable rubric source, generator, evidence, and calibration provenance models.
